...
# this script is an extension of the script todo_list_db_ex1.py
...
def new_task(tasks_list):
    ...
    while (urgent == -1):
        urgent_string = raw_input("Is this task urgent (Y/S)?\n>")
...
def remove_task(tasks_list):
    ...
    if (string in tasks_list):
        ...
        #remove from db
        db_interaction.db_remove_task(string)
    ...
    if (len(remove_list) > 0):
        for task_to_remove in remove_list:
            if (task_to_remove in tasks_list):
                ...
                #remove from db
                db_interaction.db_remove_task(task_to_remove)
